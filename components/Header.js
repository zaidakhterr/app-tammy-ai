        ...
        {user ? (
          <div className="flex items-center gap-2">
            ...
            <Menu as="div" className="relative">
              ...
              >
                <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right divide-y divide-slate-100 rounded border bg-white px-1 text-slate-700 shadow-lg dark:divide-slate-700/50 dark:border-slate-700 dark:bg-slate-800 dark:text-white">
                  <div className="py-1">
                    <Menu.Item>
                      {({ active }) => (
                        <Link
